...
import { StyleSheet, View, Text, Slider, Image, ScrollView, ProgressBarAndroid, TouchableOpacity, FlatList, AsyncStorage, Button, NativeModules } from 'react-native';
...
class Home extends Component {
    ...
    onSpeechResults(e) {
        var data = this.state.results + " " + e.value[0];
        this.setState({
            results: data
        })
