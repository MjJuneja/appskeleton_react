...
export default class KTenTestQuestionChart extends React.PureComponent {
      ...
      getChartDataUpdate= (startDate, endDate) => {
        ...
        axios({
            ...
            //   console.log("end date", endDateMoment);
              ...
              console.log("graph data",tempGraphData.points);
    ...
    _nextHandle = ()=> {
        ...
        if(this.state.valueType==0) {
            ...
            startDate = moment(startDate).startOf('day').add(1, "days").toDate().toISOString();
            endDate = moment(endDate).startOf('day').add(1, "days").toDate().toISOString();
    ...
    _previousHandle = ()=> {
        ...
        if(this.state.valueType==0) {
            ...
            let endDate = this.state.endDate;
            console.log("before", startDate, endDate);
            startDate = moment(startDate).startOf('day').subtract(1, "days").toDate().toISOString();
            endDate = moment(endDate).startOf('day').subtract(1, "days").toDate().toISOString();
            console.log("after", startDate, endDate);
            this.setState({startDate, endDate});
            this.getChartDataUpdate(startDate, endDate);
        } else if(this.state.valueType==1) {
